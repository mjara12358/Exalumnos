<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700 bg-gradient-to-b from-blue-700 to-blue-500 dark:from-blue-800 dark:to-blue-500">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    @role('Super Admin|Lider de Egresados')
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            @role('Super Admin|Lider de Egresados')
                ...
                <x-responsive-nav-link href="{{ route('exalumnos.index') }}" :active="request()->routeIs('exalumnos.index')">
                    {{ __('Exalumnos') }}
                </x-responsive-nav-link>
            @endrole
            @role('Director de Programa')
