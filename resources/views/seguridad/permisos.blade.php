<x-app-layout>
                                ...
                                <tr
                                    ...
                                    <td scope="row"
                                        ...
                                        <x-button-edit data-modal-target="editar-modal" data-modal-toggle="editar-modal"
                                            ...
                                            onclick="editarClase({{ json_encode($permiso) }})">
                                        </x-button-edit>
    ...
    <div id="agregar-modal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <!-- Modal body -->
                <form action="{{ route('permisos.store') }}" method="POST" class="p-4 md:p-5">
                    @csrf
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-4 md:p-5 text-center">
                    ...
                    <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
                        {{ __('Seguro de eliminar este Permiso!?') }}</h3>
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <form id='editar-form' method="POST" class="p-4 md:p-5">
                    ...
                    <div class="grid gap-4 mb-4 grid-cols-2">
                        <div class="col-span-2">
                            <label for="name"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">{{ __('Materia') }}</label>
    ...
    <script>
        ...
        function editarClase(permiso) {
            document.getElementById('edit-name').value = permiso.name;
            document.getElementById('editar-form').action = '/permisos/' + permiso.id;
        }
